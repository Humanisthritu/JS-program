// ques: sort the given object in the ascending order as well as descending order of name
...
// const ascSort = (obj) => {
//     const sortedData = obj.sort((a, b) => a.name.localeCompare(b.name));
//     return sortedData
// }

// const ascres = ascSort(students);
// console.log(ascres);

const desSort = (obj) =>{
    const newData = obj.sort((a,b) => b.name.localeCompare(a.name));
    return newData
}

const descres = desSort(students)
console.log(descres)